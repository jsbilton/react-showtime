...
const Moviedb = React.createClass({
    ...
    render: function() {
        return (h('div.vh-100.cover.bg-left.bg-center-l.bg-black-80.ma0.pa0', {
            style: {
                ...
                }, [h('input.pa2.input-reset.ba-white.bg-transparent.hover-bg-white.hover-black.w-50', {onChange: this.handleChange})]),
                h(Link, {
                    to: '/',
